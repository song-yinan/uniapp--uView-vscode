...
_App.default.mpType = 'app'; // 此处为演示Vue.prototype使用，非uView的功能部分
...
_vue.default.mixin(vuexStore); // 引入uView对小程序分享的mixin封装


var mpShare = __webpack_require__(/*! uview-ui/libs/mixin/mpShare.js */ 50);

_vue.default.mixin(mpShare); // i18n部分的配置
// 引入语言包，注意路径
...
var _default = {
  ...
  globalData: {},
  onLaunch: function onLaunch() {// 1.1.0版本之前关于http拦截器代码，已平滑移动到/common/http.interceptor.js中
